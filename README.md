...
## Exercises 47-48 : Weekend Status from a Given Date

### Problem Statement:

The task is to print the name of the day for a given date, and then determine whether it is a weekend or not (with the weekend being Friday and Saturday).
